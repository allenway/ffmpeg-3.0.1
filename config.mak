...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/opt/arm-ffmpeg-3.0.1 --arch=arm --cpu=armv7-a --target-os=linux --enable-cross-compile --cross-prefix=arm-linux- --enable-swscale --enable-postproc --enable-gpl --enable-ffplay --extra-ldflags=-L/opt/arm-alsa/lib --extra-cflags=-I/opt/arm-alsa/include --disable-outdev=oss --disable-indev=oss
...
CC_IDENT=gcc 4.6.2 (Freescale MAD -- Linaro 2011.07 -- Built at 2011/08/10 09:20) 20110630 (prerelease)
ARCH=arm
INTRINSICS=none
CC=arm-linux-gcc
CXX=arm-linux-g++
...
LD_PATH=-L
DLLTOOL=
WINDRES=arm-linux-windres
DEPWINDRES=arm-linux-gcc
DOXYGEN=doxygen
LDFLAGS= -L/opt/arm-alsa/lib  -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
CFLAGS-ffplay=-I/opt/arm-SDL-1.2.15/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lasound -L/opt/arm-SDL-1.2.15/lib -Wl,-rpath,/opt/arm-SDL-1.2.15/lib -lSDL -lpthread -lm -pthread -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
LIBS-ffplay=-L/opt/arm-SDL-1.2.15/lib -Wl,-rpath,/opt/arm-SDL-1.2.15/lib -lSDL -lpthread
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
